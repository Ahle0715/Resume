          ...
          <div className="container">
            ...
            <div className="achievements-grid">
              ...
              <div className="achievement-card">
                ...
                <a href="/achievements/AIoTIE2026_Award_Silver_AIOTIE2026-125.pdf" target="_blank" rel="noreferrer" className="certificate-btn" > View Certificate </a>
              </div>
              ...
              <div className="achievement-card">
                ...
                <a href="/achievements/Six Star Python Completion Certificate.pdf" target="_blank" rel="noreferrer" className="certificate-btn" > View Certificate </a>
              </div>
